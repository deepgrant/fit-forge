...
import fitforge.fit.Lap
import fitforge.fit.Record
import fitforge.fit.Session
import fitforge.fit.TimerEvent

/**
 * Runnable demonstration of the FIT codec. It is NOT part of the application — it lives in `fitforge.examples` as a
...
object FitCodecDemo {
  def main(args: Array[String]): Unit = {
    ...
    banner("fit-forge FIT codec demonstration")
